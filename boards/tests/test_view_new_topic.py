...
class NewTopicTests(TestCase):
    def setUp(self):
        ...
        User.objects.create_user(username='john', email='john@dow.com', password='1234')
    ...
    def test_new_topic_view_contains_link_back_to_board_topics_view(self):
        new_topic_rul = reverse('boards:new_topic', kwargs={'pk': 1})
        board_topics_url = reverse('boards:board_topics', kwargs={'pk': 1})
        response = self.client.get(new_topic_rul)
